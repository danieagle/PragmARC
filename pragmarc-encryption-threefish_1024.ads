...
-- **************************************************************************
--
-- Implementeation of the Threefish cipher for blocks of 1024-bits (Threefish_1024)
--
...
package PragmARC.Encryption.Threefish_1024 with preelaborate is
...
private -- PragmARC.Encryption.Threefish
   ...
   function Valid (Key_Schedule : in Key_Schedule_Handle) return Boolean is
      (Key_Schedule.Valid);
end PragmARC.Encryption.Threefish_1024;
